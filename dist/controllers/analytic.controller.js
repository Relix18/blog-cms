...
import { getAllPostsAnalytics, getAdminAnalytics, getAdminAllPostAnalytics, userAnalytics, growthReports, } from "../utils/analytics.js";
...
export const getGrowthReports = TryCatch(async (req, res, next) => {
